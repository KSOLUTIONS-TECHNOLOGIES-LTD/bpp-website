...
const slides = [
  ...
  },
  {
    ...
    selectorLabel: 'PROCUREMENT OFFICER REGISTRATION',
  },
  {
    title: 'NOCOPO',
    description:
...
export default function HeroSection() {
  ...
  return (
    <section className="w-full bg-white px-4 sm:px-8 md:px-24 pt-[12rem] pb-4 plus">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <motion.button
                ...
                className="bg-green-700 text-white px-6 py-2 md:py-4 rounded hover:bg-green-800 transition"
              >
