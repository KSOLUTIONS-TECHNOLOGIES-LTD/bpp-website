...
const WhoWeAre: FC = () => {
  return (
    <section className="relative w-full h-screen flex items-center justify-center text-center text-white pt-28 md:pt-30">
      {/* Background image */}
      ...
      <div className="relative z-10 px-4 max-w-2xl plus">
        <p className="text-[11.7px] leading-[100%] text-green-400 font-[700] mb-3 tracking-wide uppercase">
